# TODO Archive (Pre-Tidy Snapshot)

Archived from `docs/todo.md` on `2026-03-07`.
Current working backlog: `docs/todo.md`.
...
- Deferred (not active): `T54`-`T57`, `T80`-`T89`.
...
- Deferred feature and hardening candidates remain parked until explicit reprioritization.
...
## Deferred Hardening Candidates (Separate Track, Not Active)

These are explicit backlog mirrors of the `Core v1 vs v2 Summary Recommendations` in `docs/STRATEGIC_DOCUMENTATION.md`.
